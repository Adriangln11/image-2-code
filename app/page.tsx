...
export default function Home() {
	...
	return (
		<div className="grid grid-cols-[400px_1fr]">
			<aside className="text-center flex flex-col justify-between min-h-screen p-4 bg-gray-900">
				<header className="">
				...
				<footer className="text-xs opacity-60">{new Date().getFullYear()}</footer>
			</aside>
			<main>
				<div className="max-w-5xl w-full mx-auto p-10">
					...
					{step === STEPS.PREVIEW && (
						<div className="rounded border-gray-700">
							<iframe src={result} className="w-full h-full border-none" />
							<pre>
								<code>{result}</code>
							</pre>
						</div>
